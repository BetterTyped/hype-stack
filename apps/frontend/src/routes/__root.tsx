...
export const Route = createRootRoute({
  // Single source of truth for document metadata across SSR, CSR and Electron.
  // SSR renders these into <head>; in the browser React 19 hoists them there.
  head: () => ({
    meta: [
      { charSet: "utf-8" },
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      { title: "Hype Stack" },
      { name: "description", content: "Create your own hype-stack!" },
 ...
 * wrapper has to come from here. The CSR and Electron builds take it from
 * index.html and mount into #root, so it is compiled out of those bundles.
 */
