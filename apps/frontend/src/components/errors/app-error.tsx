      ...
      <div className="max-w-2xl w-full space-y-6">
        <div className="relative">
          <div className="relative space-y-2 text-center">
            ...
            <h1 className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-zinc-600 to-zinc-300/80 bg-clip-text text-center text-7xl font-semibold leading-none text-transparent dark:from-white dark:to-zinc-900/10 pb-2">
              App crashed
            </h1>
