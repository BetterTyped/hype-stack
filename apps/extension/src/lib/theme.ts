 ...
 * plugin inlines it into index.html for the CSR and Electron builds, and the
 * root route inlines it into the SSR document head. It has to run before first
 * paint, which rules out shipping it inside a bundle.
 */
